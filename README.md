...
D) Using [MacPorts](https://www.macports.org/) (Maintained by [@i0ntempest](https://github.com/i0ntempest)):
...
C) Using [NixOS](https://nixos.org/) (Maintained by [@jiegec](https://github.com/jiegec)):
